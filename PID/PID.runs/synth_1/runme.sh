...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/PIDcontroller_Verilog/PID/PID.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I_module.tcl
