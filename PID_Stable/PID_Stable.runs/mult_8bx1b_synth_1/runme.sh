...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/PIDcontroller_Verilog/PID_Stable/PID_Stable.runs/mult_8bx1b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_8bx1b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_8bx1b.tcl
